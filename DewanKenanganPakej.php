                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Dewan Kenangan (Pakej Perkahwinan)</li>
                                        </ol>
                                    </div>
                        ...
                        <!-- end page title -->
                             <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Tempahan Dewan Kenangan (Pakej Perkahwinan)</h4>
                                        ...
                                        <div id="progrss-wizard" class="twitter-bs-wizard">
                                            ...
                                            <div class="tab-content twitter-bs-wizard-tab-content">
                                                ...
                                                <div class="tab-pane" id="progress-bank-detail">
                                                    <div>
                                                        <form><br>
                                                            <h1 style="text-align: center;">SENARAI PAKEJ</h1><br>
                                                            <label>Pakej yang ditawarkan</label>
                                                                    ...
                                                                    <div class="col-xl-6"><br>
                                                                        <div class="btn-group btn-group-toggle mt-2 mt-xl-0" data-toggle="buttons">
                                                                            <label class="btn btn-light active">
                                                                                <input type="radio"  name="options" id="option1" checked>PAKEJ A
                                                                            </label>
                                                                            <label class="btn btn-light">
                                                                                <input type="radio" name="options" id="option2">PAKEJ B
                                                                            </label>
                                                                            <label class="btn btn-light">
                                                                                <input type="radio" name="options" id="option3">PAKEJ C
                                                                            </label>
                                                                        </div>
                                                                    </div>
                                                                </div>
