...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Sistem Tempahan Dewan</title>
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="index.php" class="waves-effect">
                                    <i class="ri-home-8-line"></i><span class="badge badge-pill badge-success float-right">3</span>
                                    <span>Halaman Utama</span>
                                </a>
                            </li>
                            <li>
                                <a href="JenisTempahan.php" class=" waves-effect">
                                    <i class=" ri-file-list-2-line"></i>
                                    <span>Tempahan</span>
                                </a>
                            </li>
                            <li>
                                <a href="pemohonan.php" class=" waves-effect">
                                    <i class="ri-file-2-line"></i>
                                    <span>Pemohonan Wang Pertaruhan</span>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="SenaraiGambar.php" class=" waves-effect">
