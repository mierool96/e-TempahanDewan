                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="SenaraiDewan.php">Senarai Dewan</a></li>
                        ...
                        <!-- end page title -->
                             <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Tempahan Dewan Kenangan</h4>
                                                ...
                                                <div class="tab-pane" id="progress-seller-details">
                                                    <form class="needs-validation" novalidate>
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    <label for="validationTooltip01">Nama Penuh</label>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    <label for="validationTooltip01">Organisasi/Jabatan/Agensi/Persatuan</label>
                                                                    <input type="text" class="form-control" id="organisai" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="validationTooltip01">No. Mykad/Kad Tentera/Kad Polis</label>
                                                                    <input type="text" class="form-control" id="mykad" placeholder="" required>
                                                                </div>
                                                            </div>

                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="validationTooltip01">Nombor Telefon (HP)</label>
                                                                    <input type="text" class="form-control" id="no-telefon" onkeypress="return validateNumber(event)" minlength="10" maxlength="11" required>
                                                                </div>
                                                            </div>
                                                              <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="validationTooltip01">Nombor Pejabat/Faks</label>
                                                                    <input type="text" class="form-control" id="no-pejabat" onkeypress="return validateNumber(event)" minlength="10" maxlength="11" required>
                                                                </div>
                                                            </div>
                                                             <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    <label for="validationTooltip01">Permohonan Adalah Mewakili </label>
                                                  ...
                                                  <div>
                                                    <form>
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    <label for="progress-basicpill-phoneno-input">Jenis Penggunaan</label>
                                                                    <select class="form-control">
                                                                        <option>Pilihan</option>
                                                                        <option>Majlis Perkahwinan</option>
                                                                        <option>Mesyuarat/Seminar/Jualan dan Lain-lain</option>
                                                                    </select>
                                                                </div>
                                                            </div> 
                                                            <div class="col-lg-6">
                                                ...
                                                <div class="tab-pane" id="progress-bank-detail">
                                                    ...
                                                    <h1 style="text-align: center;">SEWAAN PERALATAN</h1><br>
                                                          <div class="row">
                                                              <div class="col-lg-3">
                                                                  <div class="form-group">
                                                                      <label for="progress-basicpill-namecard-input">i. Kerusi Plastik (Per Unit)</label>
                                                                      <input id="kerusi" type="number" value="" name="kerusi">
                                                                  </div>
                                                              </div>
                                                               <div class="col-lg-3">
                                                                  <div class="form-group">
                                                                      <label for="progress-basicpill-namecard-input">ii. Kerusi Bankuet (Per Unit)</label>
                                                                      <input id="kerusi-bankuet" type="number" value="" name="kerusi-bankuet">
                                                                  </div>
                                                              </div>
                                                               <div class="col-lg-3">
                                                                  <div class="form-group">
                                                          ...
                                                          <br><hr>
                                                          <h1 style="text-align: center;">SEWAAN DEWAN</h1><br>
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                  <div class="form-group">
