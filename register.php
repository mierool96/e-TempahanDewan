                                    ...
                                    <div class="col-lg-9">
                                        <div>
                                            <div class="text-center">
                                                ...
                                                <h4 class="font-size-18 mt-4">Daftar Akaun</h4>
                                            ...
                                            <div class="p-2 mt-5">
                                                <form class="form-horizontal" action="index.html">
                                                    ...
                                                    <div class="form-group auth-form-group-custom mb-4">
                                                        ...
                                                        <input type="email" class="form-control" id="useremail" placeholder="Masukan Nama">
                                                    </div> 

                                                    <div class="form-group auth-form-group-custom mb-4">
                                                        <i class="ri-mail-line auti-custom-input-icon"></i>
                                                        <label for="useremail">Email</label>
                                                        <input type="email" class="form-control" id="useremail" placeholder="Masukan E-mel">
                                                    </div>
