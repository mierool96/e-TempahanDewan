                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Dewan Tikam Batu</li>
                                        </ol>
                                    </div>
                        ...
                        <!-- end page title -->
                             <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Tempahan Dewan Tikam Batu</h4>
                                                ...
                                                <div class="tab-pane" id="progress-bank-detail">
                                                    ...
                                                    <h1 style="text-align: center;">SEWAAN PERALATAN</h1><br>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input id="" type="number" value="" name="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
                                                                    <div class="form-group">
                                                                        <label for="progress-basicpill-namecard-input">iii. Meja Empat Segi 6'x3' (Per Unit)</label>
                                                                        <input id="" type="number" value="" name="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-lg-2">
                                                                    <div class="form-group">
                                                                        <label for="progress-basicpill-namecard-input">iv. Meja Bulat Bankuet (Per Unit)</label>
                                                                        <input id="" type="number" value="" name="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
                                                                    <div class="form-group">
                                                                        <label for="progress-basicpill-namecard-input">v. Single Sofa (Per Unit)</label>
                                                                        <input id="" type="number" value="" name="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
                                                                    <div class="form-group">
                                                                        <label for="progress-basicpill-namecard-input">vi. Rostrum Bankuet (Per Unit)</label>
                                                                        <input id="" type="number" value="" name="">
                                                                    </div>
                                                                </div>
                                                            </div>
