                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row text-center">
                                            <div class="col-6">
                                                <div class="text-center">
                                                    <!-- Large modal -->
                                                    <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target=".bs-example-modal-lg">Info Tempahan</button>
                                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-center">
                                            ...
                                            <div class="media-body">
                                                <h5 class="text-truncate"><a href="#" class="text-dark">Dewan Tikam Batu</a></h5>
                                                <p class="text-muted">
                                                    <i class="mdi mdi-account mr-1"></i> Majlis Perbandaran Sungai Petani
                                                </p>
                                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-center">
                                            ...
                                            <div class="media-body">
                                                <h5 class="text-truncate"><a href="#" class="text-dark">Dewan Bankuet</a></h5>
                                                <p class="text-muted">
                                                    <i class="mdi mdi-account mr-1"></i> Majlis Perbandaran Sungai Petani
                                                </p>
                                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-center">
                                            ...
                                            <div class="media-body">
                                                <h5 class="text-truncate"><a href="#" class="text-dark">Dewan Auditorium</a></h5>
                                                <p class="text-muted">
                                                    <i class="mdi mdi-account mr-1"></i> Majlis Perbandaran Sungai Petani
                                            </div>
                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-center">
                                            ...
                                            <div class="media-body">
                                                <h5 class="text-truncate"><a href="#" class="text-dark">Dewan Perdana Heights</a></h5>
                                                <p class="text-muted">
                                                    <i class="mdi mdi-account mr-1"></i>Majlis Perbandaran Sungai Petani
                                                </p>
                                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-center">
                                            ...
                                            <div class="media-body">
                                                <h5 class="text-truncate"><a href="#" class="text-dark">Dewan Bandar Laguna Merbok</a></h5>
                                                <p class="text-muted">
                                                    <i class="mdi mdi-account mr-1"></i> Majlis Perbandaran Sungai Petani
                                                </p>
                                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-center">
                                            ...
                                            <div class="media-body">
                                                <h5 class="text-truncate"><a href="#" class="text-dark">Dewan Jeniang</a></h5>
                                                <p class="text-muted">
                                                    <i class="mdi mdi-account mr-1"></i>Majlis Perbandaran Sungai Petani
                                                </p>
                                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-center">
                                            ...
                                            <div class="media-body">
                                                <h5 class="text-truncate"><a href="#" class="text-dark">Kompleks Sukan</a></h5>
                                                <p class="text-muted">
                                                    <i class="mdi mdi-account mr-1"></i> Majlis Perbandaran Sungai Petani
                                                </p>
                                            </div>
